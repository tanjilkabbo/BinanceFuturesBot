...
# data = GetDataframe().get_minute_data("BTCBUSD", 1, 10)
# print(data)
# tsla = get_historical_data('TSLA', '2020-01-01')
tsla = GetDataframe().get_minute_data("BTCBUSD", 1, 10)
print(tsla)
...
print(cl('Profit gained from the ST strategy by investing $100k in TSLA : {}'.format(total_investment_ret),
         attrs=['bold']))
...
# print(data)
# print(data["High"])
# get_supertrend(data["High"], data["Low"], data["Close"], 10)
# get_supertrend(data["High"], data["Low"], data["Close"], 10, multiplier)